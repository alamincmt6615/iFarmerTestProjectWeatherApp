...
import alamin.iFarmer.TestProjectWeather.CityModelRequest;
...
import alamin.iFarmer.TestProjectWeather.database.DatabaseHelper;
import com.farukydnn.weatherplus.R;
import alamin.iFarmer.TestProjectWeather.adapter.LocationsListAdapter;
...
import alamin.iFarmer.TestProjectWeather.core.ui.PermissionActivity;
import alamin.iFarmer.TestProjectWeather.core.ui.RequestFragment;
import alamin.iFarmer.TestProjectWeather.adapter.ItemTouchHelperAdapter;
import alamin.iFarmer.TestProjectWeather.interfaces.ItemTouchHelperListener;
import alamin.iFarmer.TestProjectWeather.interfaces.LocationResultListener;
import alamin.iFarmer.TestProjectWeather.interfaces.PermissionListener;
import alamin.iFarmer.TestProjectWeather.interfaces.ScreenTouchListener;
import alamin.iFarmer.TestProjectWeather.model.CityCoordinatesModel;
...
import alamin.iFarmer.TestProjectWeather.util.NetworkManager;
